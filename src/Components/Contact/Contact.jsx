...
import Resume from "../Data/Mayur's Resume.pdf"
            ...
            <Box className={styles.infoContainer}>
                <Box className={styles.linksBox}>
                    <Button
                        ...
                        onClick={()=>newTab("https://www.linkedin.com/in/mayur-kamthe-0b2012157/")}
                    >
                        LinkedIn
                    </Button>
                    <Button
                        ...
                        onClick={()=>newTab("https://github.com/mayur8600")}
                    >
                        GitHub
                    </Button>   
                    <Button                     
                        ...
                        startIcon={< EmailIcon/>}
                    >
                        <a href="mailto:mayur.kamthe62987@gmail.com" className={styles.dTag} download>
                            Email
                        </a>
                    </Button>
                    <Button
